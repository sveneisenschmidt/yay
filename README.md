...
- Native support for many third party systems like [BitBucket, GitHub, GitLab, Travis CI, Jira, Jenkins](docs/how-to.md#how-to-connect-third-parties) via [webhooks](docs/under-the-hood.md#webhooks)
