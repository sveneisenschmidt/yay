...
- Support for third party systems like [BitBucket, GitHub, GitLab, Travis CI](docs/how-to.md#how-to-connect-third-parties) via [webhooks](docs/under-the-hood.md#webhooks)
