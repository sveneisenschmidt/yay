...
- Deploy and run everywhere with Docker
- Fast and easy to learn, runs on PHP 7 and MySQL
- Easy to customise through a single configuration format
- All functions are exposed through a JSON based API
