...
| CircleCI | Continuous Integration |  build events (`build.{success, failed, canceled}`) | [Webhook documentation](https://circleci.com/docs/1.0/configuration/#notify) | [CircleCIProcessor](../src/ThirdParty/CircleCI/Webhook/Incoming/Processor/CircleCIProcessor) |
...
| TravisCI | Continuous Integration |  build events (`build.{pending, passed, fixed, failed, broken, still failing, canceled, errored}`) | [Webhook documentation](https://docs.travis-ci.com/user/notifications/#Configuring-webhook-notifications) | [TravisCIProcessor](../src/ThirdParty/TravisCI/Webhook/Incoming/Processor/TravisCIProcessor.php) |
